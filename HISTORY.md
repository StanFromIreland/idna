...
- Reject oversized labels earlier in check_label function.
- Internal tidy-up of core helpers and codec regex.
- Broaden ruff lint coverage.

Thanks to metsw24-max and Felix Yan for contributions to this release.
